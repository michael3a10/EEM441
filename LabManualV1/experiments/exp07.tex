...
% ============================================================
\experimentheader{7}{DC Motor Speed Measurement}{DC Motor Speed Measurement}{Instrumentation Lab}
...
\begin{procedure}
  ...
  \begin{boxedtable}
    ...
    {\renewcommand{\arraystretch}{1.4}
      \begin{tabular}{|c|c|c|c|c|c|c|}
        \hline
        \multirow{2}{*}{$N$} & \multicolumn{5}{c|}{$\omega$ (MeasuredRPM)} & \multirow{2}{*}{\shortstack{Oscilloscope\\(calculated RPM)}}                     \\
        \cline{2-6}
                             & \#1                                         & \#2                                                          & \#3 & \#4 & \#5 & \\
        \hline
                             &                                             &                                                              &     &     &     & \\
  ...
  \begin{boxedtable}
    ...
    {\renewcommand{\arraystretch}{1.4}
      \begin{tabular}{|c|c|c|c|c|c|c|}
        \hline
        \multirow{2}{*}{$T$ (s)} & \multicolumn{5}{c|}{$\omega$ (Measureed RPM)} & \multirow{2}{*}{\shortstack{Oscilloscope\\(calculated RPM)}}                     \\
        \cline{2-6}
                                 & \#1                                           & \#2                                                          & \#3 & \#4 & \#5 & \\
        \hline
                                 &                                               &                                                              &     &     &     & \\
