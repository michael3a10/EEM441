...
\begin{procedure}
  ...
  \begin{boxedfigure}
    ...
    \begin{minipage}[b]{0.42\linewidth}
      \centering
      \includegraphics[width=0.85\linewidth]{figures/Exp8_Figure_1.png}\\[2pt]
      {\small (a) Heater terminal}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.52\linewidth}
      \centering
      \includegraphics[width=\linewidth]{figures/Exp8_Figure_2.png}\\[2pt]
      {\small (b) connection diagram}
    \end{minipage}
    \captionof{figure}{ON/OFF control; (a) Heater terminal, (b) connection diagram.}
