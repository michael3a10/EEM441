...
% ============================================================
\experimentheader{3}{Experiment 3}{Introduction to Altera Quartus II Software}{FPGA Lab}
...
\begin{procedure}
  ...
  \begin{boxedfigure}
    \centering
    \includegraphics[width=\linewidth]{figures/Exp3_Figure_1.png}
...
\end{lstlisting}
  ...
  \begin{boxedfigure}
    \centering
    \includegraphics[width=0.65\linewidth]{figures/Exp3_Figure_2.png}
