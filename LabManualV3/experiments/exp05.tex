...
\begin{boxedfigure}
  \centering
  \includegraphics[width=\linewidth]{figures/Exp5_Figure_1.png}
...
\begin{procedure}
  ...
  \begin{enumerate}
    ...
    \item Tabulate your results in Table~\ref{tab:exp5-freerun}.
    \item Compare your hardware result with the value calculated using Equation~(1).
  \end{enumerate}

  \begin{boxedfigure}
    \centering
    \includegraphics[width=\linewidth]{figures/Exp5_Figure_2.png}
  ...
  \begin{enumerate}
    ...
    \item Tabulate your results in Table~\ref{tab:exp5-fpga}.
