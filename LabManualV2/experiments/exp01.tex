...
% ============================================================
\experimentheader{1}{Experiment 1}{DC Motor / PID Control --- Speed}{Control Lab}
...
\begin{procedure}
  ...
  \begin{enumerate}
    ...
    \item Disconnect all cable wires from the hardware module (Figure~\ref{fig:exp1-openloop}).
  ...
  \begin{boxedfigure}
    \centering
    \includegraphics[width=\linewidth]{figures/exp1-2-trainer.jpg}
  ...
  \begin{boxedfigure}
    \centering
    \includegraphics[width=0.65\linewidth, angle=90]{figures/exp1-2-controller.jpg}
    \captionof{figure}{PID Control module.}
    \label{fig:exp1-closedloop}
  \end{boxedfigure}
  ...
  \begin{enumerate}
    \item Select the P-controller by setting PROP on the controller (DIP switch 1) to ON (refer to Figure~\ref{fig:exp1-closedloop}).
