...
% ============================================================
\experimentheader{7}{Experiment 7 (RPi, open-ended)}{Speed Motor Measurement Using Raspberry Pi}{Instrumentation Lab}
...
\begin{procedure}
  ...
  \begin{boxedtable}
    ...
    \begin{tabular}{ccc}
      \toprule
      \shortstack{Input voltage\\ ($V_{in}$)} & \shortstack{Velocity (rad/s)\\(Raspberry Pi)} & \shortstack{Velocity (rad/s)\\(DSO)} \\
      \midrule
                                              &                                               &                                      \\
                                              &                                               &                                      \\
                                              &                                               &                                      \\
