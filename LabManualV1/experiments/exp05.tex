...
% ============================================================
\experimentheader{5}{LCD Interfacing}{Interfacing LCD to Altera DE2 Board}{FPGA Lab}
...
\begin{boxedfigure}
\centering
\includegraphics[width=0.85\linewidth]{figures/Exp5_Figure_1.png}
...
\begin{boxedfigure}
\centering
\includegraphics[width=0.9\linewidth]{figures/Exp5_Figure_2.png}
...
\begin{codepanel}{lcd\_t.v --- Appendix 1: lookup-table sequencer}{verilogstyle}
\begin{lstlisting}
module lcd_t (
    // Host side
    CLK, RST, mLCD_Done,
...
\begin{codepanel}{LCD\_Controller.v --- Appendix 2: bus-timing controller}{verilogstyle}
\begin{lstlisting}
